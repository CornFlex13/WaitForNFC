...
const updateStudent = async () => {
  try {
    ...
    console.error('Error updating student: ', students.value);
  }
};
...
<template>
  ...
  <div style="display: flex; justify-content: space-between;">
    ...
    <p style="font-size: 18px; text-align: end;">
      ...
      <a href="/cp422021">CP422021 - Web and Mobile Application Architectureg</a> <br />
      / Attendance Check / realtime-check
    </p>
  </div>
